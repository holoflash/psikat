        ...
        Self {
            bindings: vec![
                ...
                Binding {
                    ...
                    combo: KeyCombo::new(Key::ArrowUp),
                    title: "Field up",
                    description: "Move to the previous setting field",
                    category: "Settings",
                },
                Binding {
                    action: Action::SettingsDown,
                    combo: KeyCombo::new(Key::ArrowDown),
                    title: "Field down",
                    description: "Move to the next setting field",
                    category: "Settings",
                },
                Binding {
                    action: Action::SettingsIncrease,
                    combo: KeyCombo::new(Key::ArrowRight),
                ...
                Binding {
                    action: Action::SettingsDecrease,
                    combo: KeyCombo::new(Key::ArrowLeft),
